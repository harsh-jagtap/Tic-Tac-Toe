console.log('Wel-come to game of Tic Tac Toe');
...
function _CheckGameOver() {
    ...
    if (winner == BOARD_STATE.ai) {
        desc = 'You lose ! Game will restart in 5s';
    } else if (winner == BOARD_STATE.player) {
        desc = 'You win ! Game will restart in 5s ';
    } else {
        desc = 'Tie game, try again. Game will restart in 5s '
    }
